...
![VSCode SCM]({{ site.baseurl }}/assets/images/VSCode-SCM-300x227.jpg)

and the changes can be staged by clicking the plus next to the file

![VSCode Stage]({{ site.baseurl }}/assets/images/VSCode-Stage-300x21.jpg)

then they can be committed by clicking the check mark at the top

![VSCode Commit]({{ site.baseurl }}/assets/images/VSCode-Commit-300x36.jpg)
